...
SECRET_KEY = "django-insecure-n#s5jh1h@w&67^^dp=q+^s#c$qmt#t2%uzr)wpa0gi_n6_nc$2"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '192.168.10.229']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'uzzalbhuiyan905@gmail.com' 
EMAIL_HOST_PASSWORD = 'aawx flgg besg rmxe'
